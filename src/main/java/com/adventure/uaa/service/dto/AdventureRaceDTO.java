...
/**
 * A DTO for the {@link com.adventure.uaa.domain.AdventureRace} entity.
 */
public class AdventureRaceDTO implements Serializable {
    ...
    private Long adventureAccountCharacterId;
    ...
    public Long getAdventureAccountCharacterId() {
        return adventureAccountCharacterId;
    }

    public void setAdventureAccountCharacterId(Long adventureAccountCharacterId) {
