...
/**
 * REST controller for managing {@link com.adventure.uaa.domain.AdventureAccountCharacter}.
 */
@RestController
@RequestMapping("/api")
public class AdventureAccountCharacterResource {
    ...
    public ResponseEntity<AdventureAccountCharacterDTO> getAdventureAccountCharacter(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteAdventureAccountCharacter(@PathVariable Long id) {
