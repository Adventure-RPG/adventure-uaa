...
/**
 * REST controller for managing {@link com.adventure.uaa.domain.AdventureInventoryChar}.
 */
@RestController
@RequestMapping("/api")
public class AdventureInventoryCharResource {
    ...
    public ResponseEntity<AdventureInventoryCharDTO> getAdventureInventoryChar(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteAdventureInventoryChar(@PathVariable Long id) {
