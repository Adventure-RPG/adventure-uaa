...
/**
 * REST controller for managing {@link com.adventure.uaa.domain.AdventureItem}.
 */
@RestController
@RequestMapping("/api")
public class AdventureItemResource {
    ...
    public ResponseEntity<AdventureItemDTO> getAdventureItem(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteAdventureItem(@PathVariable Long id) {
